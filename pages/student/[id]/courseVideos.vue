    ...
    <div class="bg-blue-50 rounded-xl p-4 mb-6">
      <div class="flex flex-wrap gap-4">
        <div class="flex-1 min-w-[200px]">
          <label class="block text-sm font-medium text-gray-700 mb-1">课程筛选</label>
          <select
        ...
        <div class="flex-1 min-w-[200px]">
          <label class="block text-sm font-medium text-gray-700 mb-1">讲师筛选</label>
          <select
            class="w-full rounded-lg border border-gray-300 px-3 py-2 focus:outline-none focus:ring-2 focus:ring-blue-500"
          >
            <option>全部讲师</option>
      ...
      >
        <div class="p-4">
          <h3 class="font-bold text-lg mb-1">
            {{ video.course_name }} - {{ video.video_title }}
          </h3>
          ...
          <div class="flex justify-between items-center">
            ...
            <span
              v-else
              class="text-sm bg-orange-100 text-orange-800 px-2 py-1 rounded"
            >未观看</span>
          </div>
        </div>
      </div>
